...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder> implements Filterable{
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull final View itemView) {
            ...
            ImageButton close = itemView.findViewById(R.id.close);
            ...
            emailBut.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"grvor.antonyan94@gmail.com"});
                    intent.putExtra(Intent.EXTRA_SUBJECT, "ITC-Homework");
                    intent.putExtra(Intent.EXTRA_TEXT, "I'm email body.");
                    emailBut.getContext().startActivity(Intent.createChooser(intent, "Send Email"));
                }
            });
            ...
            callBut.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String phone = "+37495800177";
                    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", phone, null));
                    callBut.getContext().startActivity(intent);
                }
            });
            ...
            close.setOnClickListener(new ImageButton.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DataProvider.users.remove(itemView.getVerticalScrollbarPosition());
                    notifyDataSetChanged();
                }
            });
